  ...
  Future<void> getTime() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        //       // Parse the offset string (e.g., '+05:30' or '-02:00') to get the hours and minutes.
        //       int hours =
        //           int.parse(offsetString.substring(1, 3)); // Extract hours
        //       int minutes =
        //           int.parse(offsetString.substring(4)); // Extract minutes
